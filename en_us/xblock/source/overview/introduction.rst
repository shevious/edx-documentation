...
As a developer, you build XBlocks that course authors use to create independent
...
interactive learning laboratories, course staff can create rich and engaging
courseware.
